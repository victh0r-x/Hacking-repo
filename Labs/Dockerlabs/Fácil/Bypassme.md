...
![Pasted image 20251014084413](Hacking-repo-obs/Anexos/Pasted%20image%2020251014084413.png)
...
![Pasted image 20251014084432](Hacking-repo-obs/Anexos/Pasted%20image%2020251014084432.png)

Ahora vamos a entrar al sitio web para averiguar de qué se trata:

![Pasted image 20251014085123](Hacking-repo-obs/Anexos/Pasted%20image%2020251014085123.png)

Pruebo estas credenciales:

admin' or '1'='1 : admin' or '1'='1

![Pasted image 20251014092252](Hacking-repo-obs/Anexos/Pasted%20image%2020251014092252.png)

Ahora accedemos al recurso .logs con la siguiente URL:

![Pasted image 20251014093804](Hacking-repo-obs/Anexos/Pasted%20image%2020251014093804.png)

Ahora ejecutando ps -aux  vemos también lo siguiente:

![Pasted image 20251014094737](Hacking-repo-obs/Anexos/Pasted%20image%2020251014094737.png)
...
![Pasted image 20251014095026](Hacking-repo-obs/Anexos/Pasted%20image%2020251014095026.png)

Ahora inspeccionamos  que el usuario root está ejecutando una tarea cron.d:

![Pasted image 20251014101146](Hacking-repo-obs/Anexos/Pasted%20image%2020251014101146.png)

Vamos a cambiar el contenido de ese script backup.sh por un código malicioso que le otorgue permisos SUID a la bash:

![Pasted image 20251014101619](Hacking-repo-obs/Anexos/Pasted%20image%2020251014101619.png)

Una vez hecho y tras esperar unos segundos, se activa el script:

![Pasted image 20251014101914](Hacking-repo-obs/Anexos/Pasted%20image%2020251014101914.png)

Ahora ejecutamos /bin/bash -p

![Pasted image 20251014102903](Hacking-repo-obs/Anexos/Pasted%20image%2020251014102903.png)
Y somos root!!