...
Este comando significa que **socat se pone en escucha por el puerto 4445 de la máquina pivote 192.168.0.211** y **redirige el flujo de la ejecución hacia la máquina dentro de la red interna con ip 10.10.10.134**.
De esta forma todo lo que enviemos al puerto 4445 de la IP 192.168.0.211 se enviará al puerto 445 de la IP 10.10.10.134.
...
![Pasted image 20251204222041](Hacking-repo-obs/Anexos/Pasted%20image%2020251204222041.png)
...
![Pasted image 20251204222156](Hacking-repo-obs/Anexos/Pasted%20image%2020251204222156.png)

Metasploit (Atacante)
    ↓
Envía exploit a 192.168.0.211:4445
    ↓
Socat (en B) escucha en :4445
    ↓
Socat redirige a 10.10.10.134:445
    ↓
EternalBlue explota 10.10.10.134:445
...
![Pasted image 20251204223813](Hacking-repo-obs/Anexos/Pasted%20image%2020251204223813.png)
