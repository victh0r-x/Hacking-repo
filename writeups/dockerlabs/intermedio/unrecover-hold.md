...
![Pasted image 20251017050258](<../../../.gitbook/assets/Pasted image 20251017050258.png>)
...
![Pasted image 20251017050402](<../../../.gitbook/assets/Pasted image 20251017050402.png>)

Vamos a acceder al servicio web para ver de qué se trata:

![Pasted image 20251017050719](<../../../.gitbook/assets/Pasted image 20251017050719.png>)

Vemos una página de capybaras, donde además podemos ver que tenemos un usuario descubierto: **capybara**. Voy a intentar hacer un ataque de fuerza bruta con hydra al servicio mysql y al servicio ftp para ver qué consigo:

```bash
hydra -l capybara -P /usr/share/wordlists/rockyou.txt -I mysql://172.17.0.2
```

![Pasted image 20251017052306](<../../../.gitbook/assets/Pasted image 20251017052306.png>)

![Pasted image 20251017053607](<../../../.gitbook/assets/Pasted image 20251017053607.png>)

> NOTA: Si alguna vez algo del lado del cliente da este error, podemos agregar el parámetro --skip\_ssl

![Pasted image 20251017053935](<../../../.gitbook/assets/Pasted image 20251017053935.png>)
...
![Pasted image 20251017054352](<../../../.gitbook/assets/Pasted image 20251017054352.png>)

Ahora que tenemos un usuario y una contraseña, vamos a intentar crackearla con la web de crackstation:

![Pasted image 20251017054707](<../../../.gitbook/assets/Pasted image 20251017054707.png>)
